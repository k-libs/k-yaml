...
fun interface ReaderFn {
   ...
   * be thrown.
   *
   * If `buffer` has a size of `0` or `len` is equal to `0`, then this function
   ...
   *
   * @param len Maximum number of bytes to read from the source into the given
   * [buffer].
   *
